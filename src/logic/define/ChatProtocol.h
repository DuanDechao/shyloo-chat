...
enum ChatProtocolID{
	...
	CHATGATE_MSG_SYNC_TICKET = 4,

	CHANNEL_MSG_SYNC_TOKEN = 52,
	
	BALANCE_MSG_CHANNEL_ADDRESS_INFO_SYNC = 101,

	AUTH_MSG_SYNC_TOKEN_RES = 151,
	AUTH_MSG_SYNC_TOKEN = 152,
	AUTH_MSG_VERIFY_TOKEN_RES = 153,

	CHAT_API_RGS_LISTENER = 301,

	CHAT_API_RGS_LISTENER_RES = 401,
