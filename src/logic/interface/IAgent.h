...
public:
	...
	virtual void onAgentOpen(sl::api::IKernel* pKernel, const int8 type, const int64 id) = 0;
	virtual void onAgentClose(sl::api::IKernel* pKernel, const int8 type, const int64 id) = 0;
	virtual int32 onAgentRecv(sl::api::IKernel* pKernel, const int8 type, const int64 id, const void* context, const int32 size) = 0;
};
